                ...
                <div class="col-md-6" style="left: 0px; width: 53.5%; top: 25px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4><strong><p style='color: CornflowerBlue'>Advising 
									</p>
                                </strong>
                            </h4>
                        </div>
                        <div class="panel-body">
                            <form class="form form-vertical=" method = "POST" action = '../controllers/advise_student.php'>
                                <label>Student ID</label>
                                <div class="controls">
                                    <input type="number" class="form-control" placeholder="Enter ID" style="width: 24%" name="StudentID" required>
                                </div>
                                <label> Semester </label>
                                <select name="Semester" class="form-control" style = "width: 25%" required>
