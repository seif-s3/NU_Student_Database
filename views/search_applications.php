                ...
                <div class="col-md-6" style="left: 0px; width: 53.5%; top: 25px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4><strong><p style='color: CornflowerBlue'>Search Submitted Applications
									</p>
                                </strong>
                            </h4>
                        </div>
                        <div class="panel-body">
                            <form class="form form-vertical=" method="post" action="../views/view_applications_ui.php" >
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control" placeholder="Enter Name" name="Name" style="width: 50%">
                                    </div>
                                </div>
                                ...
                                <select name="AppliedSchool" class="form-control" style = "width: 50%">
                                ...
                                <select name="IntendedMajor" class="form-control" style = "width: 50%">
                                ...
                                <select name="AppliedSemester" class="form-control" style = "width: 50%">
                                ...
                                <select name="AppliedYear" class="form-control" style = "width: 50%">
