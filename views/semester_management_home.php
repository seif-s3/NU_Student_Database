            ...
            <div class="col-md-6" style="left: 0px; width: 53.5%; top: 25px">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><strong><p style='color: CornflowerBlue'>Offer Course to Semester
								</p>
                            </strong>
                        </h4>
                    </div>
                    <div class="panel-body">
                        <form class="form form-vertical=" method='post' action = '../controllers/manage_semester_courses.php'>
                            ...
                            <label> Year </label>
                            <select name="Year" class="form-control" style = "width: 25%" required>
