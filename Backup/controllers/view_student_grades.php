                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php
								...
								$sql = "SELECT CourseID as 'Course ID', CourseName as 'Course Name', CreditHours as 'Credit Hours', SectionID as 'Section ID', SemesterTaken as 'Semester', YearTaken as 'Year', Grade
										FROM takes NATURAL JOIN course WHERE StudentID = '$StudentID' ORDER BY Year, SemesterTaken";
