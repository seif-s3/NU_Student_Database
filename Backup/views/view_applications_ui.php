                            ...
                            <?php
								...
								if($Name == "" && $ApplicationID == "" && $IntendedMajor == "" && $AppliedSchool == "" && $AppliedYear=="" && $AppliedSemester=="")
								{
                                    ...
                                    else
                                    {
                                        ...
                                        echo "<th style='color: CornflowerBlue'><span class='auto-style3'>More Info</span></th>";
                                        echo "<th style='color: CornflowerBlue'><span class='auto-style3'>Accept Applicant</span></th></tr>";
