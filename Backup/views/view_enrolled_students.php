                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php
								...
								if($Name == "" && $StudentID == "" && $MajorID == "" && $SchoolID == "")
								{
                                    $sql = "SELECT StudentID as 'Student ID', FirstName as 'First Name', LastName as 'Last Name', enrollements.student.MajorID as 'Major', SchoolID as 'School', GPA, CreditsTaken as 'Credits Taken' 
                                            FROM applicants.applicant JOIN enrollements.student ON applicants.applicant.ApplicationID = enrollements.student.StudentID 
                                            INNER JOIN enrollements.major ON enrollements.major.MajorID = enrollements.student.MajorID";
                                    ...
                                    else
                                    {
                                        ...
                                        echo "<th style='color: CornflowerBlue'><span class='auto-style3'>Application Info</span></th>";
                                        echo "<th style='color: CornflowerBlue'><span class='auto-style3'>Courses Taken</span></th></tr>";
                                        for($i =0 ; $i<mysql_num_rows($query_result) ; $i++){
                                            ...
                                            echo "<th><form method='post' action='../controllers/view_single_application.php'>
                                            <button type='submit' class='btn btn-link' name='ID' value='$AppID'>View All Info</button></form></th>";
                                            echo "<th><form method='post' action='../controllers/get_transcript.php'>
                                            <button type='submit' class='btn btn-link' name='ID' value='$AppID'>View Grades</button></form></th>";
                                            echo "</tr>";
                                        }
                                        echo "</table>";
                                    }
								...
								else
                                {
    								$sql = "SELECT StudentID as 'Student ID', FirstName as 'First Name', LastName as 'Last Name', enrollements.student.MajorID as 'Major', SchoolID as 'School', GPA, CreditsTaken as 'Credits Taken' 
    								FROM applicants.applicant JOIN enrollements.student ON applicants.applicant.ApplicationID = enrollements.student.StudentID 
    								INNER JOIN enrollements.major ON enrollements.major.MajorID = enrollements.student.MajorID WHERE ";
    								
    								$multiple = false;
    								if($StudentID != "")
    								{
    									$sql .= " student.StudentID = '$StudentID'";
    									$multiple = true;
    								}
    								if($MajorID != "")
    								{
    									...
    									$sql .= " enrollements.student.MajorID = '$MajorID'";
    									$multiple = true;
    								}
    								if($SchoolID != "")
    								{
    									...
    									$sql .= " enrollements.major.SchoolID = '$SchoolID'";
    									$multiple = true;
    								}
    								if($Name != "")
    								{
