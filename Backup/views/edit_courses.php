                ...
                <div class="col-md-6" style="left: 0px; width: 53.5%; top: 25px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4><strong><p style='color: CornflowerBlue'>Edit Courses
                                    </p>
                                </strong>
                            </h4>
                        </div>
                        <div class="panel-body">
                            <form class="form form-vertical=" method = 'post' action = '../controllers/edit_course_details.php'>
                                <?php
                                ...
                                <div class="controls">
                                    <select required autocomplete type class="form-control" placeholder="Enter Course ID" style="width: 75%" name="CourseID" >
