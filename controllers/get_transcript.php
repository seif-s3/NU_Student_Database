            ...
            <div class="row">
                ...
                <div class="col-md-6" style="left: 0px; width: 53.5%; top: 25px">
                    <div class="panel panel-default">
                        <div class="panel-heading" <p style='color: CornflowerBlue'>
                            <h4><strong>Transcript
                                </strong>
                            </h4>
							</p>
                        </div>
                        <div class="panel-body">
                            ...
                            <?php
								...
								$sql = "SELECT CourseID as 'Course ID', CourseName as 'Course Name', CreditHours as 'Credit Hours', SemesterTaken as 'Semester', YearTaken as 'Year', Grade
										FROM takes NATURAL JOIN course WHERE StudentID = '$StudentID' ORDER BY Year ASC, SemesterTaken DESC";
